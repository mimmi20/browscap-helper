...
if (file_exists(__DIR__ . DIRECTORY_SEPARATOR . 'uas-' . $issue . '.txt')) {
    $fileContents = file(__DIR__ . DIRECTORY_SEPARATOR . 'uas-' . $issue . '.txt', FILE_SKIP_EMPTY_LINES | FILE_IGNORE_NEW_LINES);
} elseif (file_exists(__DIR__ . DIRECTORY_SEPARATOR . 'uas-' . $issue . '.yaml')) {
    $list = Yaml::parse(file_get_contents(__DIR__ . DIRECTORY_SEPARATOR . 'uas-' . $issue . '.yaml'));
    $fileContents = [];
...
file_put_contents(__DIR__ . DIRECTORY_SEPARATOR . 'issue-' . $issue . '.php', $outputBrowscap);
file_put_contents(__DIR__ . DIRECTORY_SEPARATOR . 'browscap-issue-' . $issue . '.php', $outputDetector);
